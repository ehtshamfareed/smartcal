...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $micros = [
            'calcium' => round($consumed_calories * 0.4, 1), 
            'iron' => round($consumed_calories * 0.005, 1), 
            'vit_c' => round($consumed_calories * 0.03, 1), 
            'potassium' => round($consumed_calories * 1.5, 1), 
            'fiber' => round($consumed_calories * 0.015, 1), 
            'water' => round($consumed_calories * 0.02, 1), 
            'vit_a' => round($consumed_calories * 0.3, 1), 
            'vit_b12' => round($consumed_calories * 0.001, 2), 
        ];
