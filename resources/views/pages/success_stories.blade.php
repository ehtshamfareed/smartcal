...
<head>
    ...
    <title>Success Stories | SmartCal</title>
    ...
    <style>
        ...
        .stars-container { margin-bottom: 1.5rem; }
        .info-card .stars-container i { display: inline-block; font-size: 1.2rem; color: #f59e0b; margin-bottom: 0; margin-right: 2px; }
...
<body>
    ...
    <div class="page-hero">
        <div class="reveal">
            ...
            <p>Read how SmartCal has helped thousands of members achieve their health and fitness goals.</p>
        </div>
    </div>
    <div class="content-wrap">
                    <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?auto=format&fit=crop&q=80&w=600" class="page-hero-img" alt="Success Stories" onerror="this.src='https://via.placeholder.com/600x400/10b981/ffffff?text=Success+Stories'">
            <div class="card-grid">
                <div class="info-card reveal">
                    <div class="stars-container"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                    <p style="font-style: italic; font-size: 1.15rem; color: #334155; line-height: 1.6; margin-bottom: 2rem;">"Mainay 3 mahinay mein 8 kg weight lose kiya just by portion control. SmartCal ki wajah se desi khanon ki calories track karna bohat asaan ho gaya hai!"</p>
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=150&q=80" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;" alt="Ayesha">
                        <div>
                            <h4 style="margin: 0; color: #0f172a; font-weight: 700; font-family: 'Outfit';">Ayesha Ali</h4>
                            <p style="margin: 0; font-size: 0.85rem; color: #64748b; text-transform: uppercase; font-weight: 600;">Lost 8 Kg</p>
                        </div>
                    </div>
                </div>
                <div class="info-card reveal">
                    <div class="stars-container"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i></div>
                    <p style="font-style: italic; font-size: 1.15rem; color: #334155; line-height: 1.6; margin-bottom: 2rem;">"Gym routine ke sath macros manage karna hamesha mushkil lagta tha. Is app ne meri diet aur protein intake ko track karna intehai simple bana diya hai."</p>
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;" alt="Hamza">
                        <div>
                            <h4 style="margin: 0; color: #0f172a; font-weight: 700; font-family: 'Outfit';">Hamza Tariq</h4>
                            <p style="margin: 0; font-size: 0.85rem; color: #64748b; text-transform: uppercase; font-weight: 600;">Fitness Enthusiast</p>
                        </div>
                    </div>
                </div>
                <div class="info-card reveal">
                    <div class="stars-container"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                    <p style="font-style: italic; font-size: 1.15rem; color: #334155; line-height: 1.6; margin-bottom: 2rem;">"Mujhe laga tha diet ka matlab bhooka rehna hai. SmartCal use karne ke baad mujhe apni eating habits aur daily water intake pe pura control aa gaya hai!"</p>
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <img src="https://images.unsplash.com/photo-1599566150163-29194dcaad36?auto=format&fit=crop&w=150&q=80" style="width: 50px; height: 50px; border-radius: 50%; object-fit: cover;" alt="Sana">
                        <div>
                            <h4 style="margin: 0; color: #0f172a; font-weight: 700; font-family: 'Outfit';">Sana Khan</h4>
                            <p style="margin: 0; font-size: 0.85rem; color: #64748b; text-transform: uppercase; font-weight: 600;">Healthy Lifestyle</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-content reveal" style="margin-top: 3rem;">
                <h3>Join the SmartCal Community</h3>
                <p>These stories are just a fraction of the transformations happening within the SmartCal community every day. Whether your goal is weight loss, muscle gain, or simply building a healthier relationship with food, you are not alone on this journey.</p>
                <p>When you sign up, you gain access to our member forums where you can share tips, recipes, and your own progress milestones. We believe that a supportive community is one of the strongest predictors of long-term success.</p>
            </div>
        </div>
    <!-- Footer -->
    <footer class="footer">
