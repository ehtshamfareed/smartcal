...
<body>
    ...
    <div class="page-hero">
        <div class="reveal">
            ...
            <p>We take your data security and personal privacy seriously.</p>
        </div>
    </div>
    <div class="content-wrap">
            <div class="text-content reveal">
                ...
                <ul>
                    <li>To personalize your nutrition targets and suggest caloric intakes.</li>
                    <li>To sync data securely across your devices so you can track on the go.</li>
