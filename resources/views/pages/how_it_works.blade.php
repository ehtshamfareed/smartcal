...
<head>
    ...
    <title>How It Works | SmartCal</title>
...
<body>
    ...
    <div class="page-hero">
        <div class="reveal">
            <h1>How It Works</h1>
            <p>Your journey to a healthier you, simplified into three easy steps.</p>
        </div>
    </div>
    <div class="content-wrap">
                    <img src="https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&q=80&w=600" class="page-hero-img" alt="How it works" onerror="this.src='https://via.placeholder.com/600x400/10b981/ffffff?text=How+it+works'">
            <img src="https://images.unsplash.com/photo-1498837167922-41c53b4f094b?auto=format&fit=crop&q=80&w=600" class="page-hero-img-left" alt="How it works" onerror="this.src='https://via.placeholder.com/600x400/10b981/ffffff?text=How+it+works'">
            <div class="card-grid">
                <div class="info-card reveal">
                    <i class="fas fa-user-plus"></i>
                    <h3>1. Setup Your Profile</h3>
                    <p>Tell us your age, weight, height, and activity level. Our algorithm will immediately calculate your TDEE (Total Daily Energy Expenditure) and set baseline goals.</p>
                </div>
                <div class="info-card reveal">
                    <i class="fas fa-utensils"></i>
                    <h3>2. Log Your Meals</h3>
                    <p>Use our intuitive search feature to log your meals. The visual dashboard will update in real-time, showing how many calories and macros you have remaining.</p>
                </div>
                <div class="info-card reveal">
                    <i class="fas fa-chart-pie"></i>
                    <h3>3. Analyze & Adapt</h3>
                    <p>Review your weekly charts. Are you hitting your protein goals? Are you staying hydrated? Use the insights to tweak your diet for the following week.</p>
                </div>
            </div>
            
            <div class="text-content reveal" style="margin-top: 3rem;">
                <h3>The Science Behind SmartCal</h3>
                <p>We believe that nutrition tracking shouldn't be a guessing game. SmartCal utilizes a massive database of verified foods, cross-referenced with standards, to ensure that the macros and micros you see are accurate.</p>
                <p>Our algorithms take into account your baseline metabolic rate, your chosen activity levels, and your overall goals (maintenance, weight loss, or muscle gain) to dynamically adjust your targets.</p>
                <ul>
                    <li><strong>Verified Data:</strong> No more user-submitted errors. We verify our food entries.</li>
                    <li><strong>Dynamic Targets:</strong> Your goals shift as you progress, and so should your targets.</li>
                    <li><strong>Holistic Overview:</strong> Track water, sleep, and exercise alongside your diet.</li>
                </ul>
                <h3>Getting Started is Easy</h3>
                <p>To begin, simply create an account. You'll be prompted to enter your current health metrics. Be as honest as possible—this is the foundation of your caloric calculations. Once you're in, start searching for the foods you eat daily. You'll quickly see patterns emerge, allowing you to make small, sustainable tweaks rather than restrictive dieting overhauls.</p>
            </div>    
        </div>
    <!-- Footer -->
    <footer class="footer">
