...
<head>
    ...
    <title>Platform Features | SmartCal</title>
...
<body>
    ...
    <div class="page-hero">
        <div class="reveal">
            ...
            <p>Discover the powerful tools we have built to help you track, analyze, and optimize your nutrition.</p>
        </div>
    </div>
    <div class="content-wrap">
                    <img src="https://images.unsplash.com/photo-1543362906-acfc16c67564?auto=format&fit=crop&q=80&w=600" class="page-hero-img" alt="Features" onerror="this.src='https://via.placeholder.com/600x400/10b981/ffffff?text=Features'">
            <div class="card-grid">
                <div class="info-card reveal">
                    <i class="fas fa-database"></i>
                    <h3>Massive Food Database</h3>
                    <p>Search over millions of verified food items. From raw ingredients to restaurant meals, our database has accurate macro and micronutrient profiles.</p>
                </div>
                <div class="info-card reveal">
                    <i class="fas fa-chart-line"></i>
                    <h3>7-Day Rolling Averages</h3>
                    <p>Stop obsessing over daily weight fluctuations. Our smoothing algorithms show your true progress by analyzing weekly trends in weight and caloric intake.</p>
                </div>
                <div class="info-card reveal">
                    <i class="fas fa-mobile-alt"></i>
                    <h3>Cross-Device Sync</h3>
                    <p>Log your breakfast on your phone, review your charts on your laptop. SmartCal syncs seamlessly in real-time across all your devices.</p>
                </div>
                <div class="info-card reveal">
                    <i class="fas fa-heartbeat"></i>
                    <h3>Integration Ready</h3>
                    <p>Connect with Apple Health, Google Fit, and Fitbit to automatically import your steps, workouts, and biometrics directly into your daily log.</p>
                </div>
            </div>
            
            <div class="text-content reveal" style="margin-top: 3rem;">
                <h3>Why SmartCal Stands Out</h3>
                <p>Most calorie counters treat all calories as equal. SmartCal goes deeper, breaking down your meals into macronutrients (Proteins, Fats, Carbohydrates) and essential micronutrients. This level of detail empowers you to optimize your diet for specific goals, whether it's building lean muscle or improving energy levels.</p>
                <ul>
                    <li><strong>Barcode Scanner:</strong> Instantly log packaged foods using your phone's camera.</li>
                    <li><strong>Custom Recipes:</strong> Cook a lot? Create and save your own custom meals and recipes for one-tap logging in the future.</li>
                    <li><strong>Detailed Analytics:</strong> Go beyond the daily view. Explore 30-day, 90-day, and yearly charts to understand the bigger picture of your health journey.</li>
                </ul>
                <p>Our platform is continuously evolving, driven by user feedback and the latest nutritional science. We aim to provide the most comprehensive, yet user-friendly tool on the market.</p>
            </div>
        </div>
    <!-- Footer -->
    <footer class="footer">
